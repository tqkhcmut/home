...
#define BOOTP_LEN 300 // not sure

#define BOOTP_MSG_TYPE_P (IP_HEADER_LEN + UDP_HEADER_LEN) // 1 byte
#define BOOTP_HARD_TYPE_P 			(BOOTP_MSG_TYPE_P + 1) // 1 byte
#define BOOTP_HARD_ADDR_LENGTH_P 	(BOOTP_MSG_TYPE_P + 2) // 1 byte
#define BOOTP_HARD_HOPS_P 			(BOOTP_MSG_TYPE_P + 3) // 1 byte
#define BOOTP_TRANSACTION_ID_P 		(BOOTP_MSG_TYPE_P + 7) // 4 byte
#define BOOTP_SECONDS_ELAPSED_P		(BOOTP_MSG_TYPE_P + 11) // 2 byte
#define BOOTP_BOOTP_FLAGS_P 		(BOOTP_MSG_TYPE_P + 13) // 2 byte
#define BOOTP_CLIENT_IP_ADDRESS_P 	(BOOTP_MSG_TYPE_P + 15) // 4 byte
#define BOOTP_YOUR_IP_ADDRESS_P 	(BOOTP_MSG_TYPE_P + 19) // 4 byte
#define BOOTP_NEXT_SERVER_IP_ADDRESS_P 		(BOOTP_MSG_TYPE_P + 23) // 4 byte
#define BOOTP_RELAY_AGENT_IP_ADDRESS_P 		(BOOTP_MSG_TYPE_P + 27) // 4 byte
#define BOOTP_CLIENT_MAC_ADDRESS_P 		(BOOTP_MSG_TYPE_P + 31) // 6 byte
// Client hardware address padding: 10 bytes
#define BOOTP_CLIENT_HARD_ADDR_PADDING_P 		(BOOTP_MSG_TYPE_P + 37) // 10 byte
// Server Host name: 64 bytes
#define BOOTP_SERVER_HOST_NAME_P 		(BOOTP_MSG_TYPE_P + 47) // 64 byte
// Boot file name: 128 bytes
#define BOOTP_BOOT_FILE_NAME_P 		(BOOTP_MSG_TYPE_P + 101) // 128 byte
